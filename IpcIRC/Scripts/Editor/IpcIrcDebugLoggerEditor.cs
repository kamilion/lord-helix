...
[CustomEditor(typeof(IpcIrcDebugLogger))]
public class IpcIrcDebugLoggerEditor : Editor
{
    public override void OnInspectorGUI()
    {
        //DrawDefaultInspector(); // debugging
        IpcIrcDebugLogger myLog = (IpcIrcDebugLogger)target; // Grab a reference to the real script.
